...
#include "Resource-Intermediate-iOS/Shaders.metallib.h"
#include "Resource-Intermediate-iOS/l_hires.h"
...
void write_assets()
{
    ...
    //Shaders.metallib
    {
        ...
        ssize_t res1 = write(fd_metallib, Resource_Intermediate_iOS_Shaders_metallib, Resource_Intermediate_iOS_Shaders_metallib_len);
        assert(res1 != -1 && res1 == Resource_Intermediate_iOS_Shaders_metallib_len);
    ...
    //l_hires
    {
        ...
        ssize_t res1 = write(fd_l_hires, ThirdParty_Assets_Lenna_l_hires_ASTC_pvr, ThirdParty_Assets_Lenna_l_hires_ASTC_pvr_len);
        assert(res1 != -1 && res1 == ThirdParty_Assets_Lenna_l_hires_ASTC_pvr_len);
